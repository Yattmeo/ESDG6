...
-- Create the EHR database if not exists
...
-- Insert data into the `ehr` table
INSERT INTO `ehr` (`patient_id`, `medical_conditions`, `allergies`, `medications`, `surgeries`, `immunisations`, `family_medical_history`, `past_appointments`) VALUES
    (1, 'Hypertension', 'Penicillin', 'Lisinopril', 'Appendectomy', 'Flu Vaccine', 'Heart disease in family', '2023-01-15T10:30:00Z'),
    (2, 'Diabetes', NULL, 'Metformin', NULL, NULL, NULL, '2022-12-20T09:15:00Z'),
    (3, 'Asthma', '["Aspirin", "Dust"]', 'Albuterol', 'Tonsillectomy', 'Tdap Vaccine', 'Asthma in family', '2023-03-05T11:00:00Z');
